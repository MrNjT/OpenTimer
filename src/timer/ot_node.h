...
class Node {
  ...
  public:
    ...
    bool_t is_clock_tree_leaf() const;                      // Query if the node is a clock tree leaf.
    ...
    inline size_t num_jumpins() const;                      // Query the fanin jump size.
    inline size_t num_jumpouts() const;                     // Query the fanout jump size.
    ...
    inline edgelist_rt fanin() const;                       // Query the fanin ref.
    inline edgelist_pt fanout_ptr() const;                  // Query the fanout pointer.
    inline edgelist_rt fanout() const;                      // Query the fanout ref.
    inline jumplist_pt jumpin_ptr() const;                  // Query the jumpin pointer.
    inline jumplist_rt jumpin() const;                      // Query the jumpin.
    inline jumplist_pt jumpout_ptr() const;                 // Query the jumpout pointer.
    inline jumplist_rt jumpout() const;                     // Query the jumpout.
    ...
    Node & operator = (const Node &) = delete;              // Disable copy assignment.
...
// Function: num_fanins
// Return the number of fanin edges.
inline size_t Node::num_fanins() const {
  return fanin_ptr()->size();
}

// Function: fanout_size
// Return the number of fanin edges.
inline size_t Node::num_fanouts() const {
  return fanout_ptr()->size();
}

// Function: num_jumpins
inline size_t Node::num_jumpins() const {
  return jumpin_ptr()->size();
}

// Function: num_jumpouts
inline size_t Node::num_jumpouts() const {
  return jumpout_ptr()->size();
}
...
// Function: fanin
// Return the ref to the fanin list.
inline edgelist_rt Node::fanin() const {
  return *_fanin_ptr;
}
...
// Function: fanout
// Return the ref to the fanout list.
inline edgelist_rt Node::fanout() const {
  return *_fanout_ptr;
}
...
// Function: jumpin
// Return the ref to the jumpin list.
inline jumplist_rt Node::jumpin() const {
  return *_jumpin_ptr;
}
...
// Function: jumpout
// Return the ref to the jumpout list.
inline jumplist_rt Node::jumpout() const {
  return *_jumpout_ptr;
}
...
inline void_t Node::remove_slew(int el, int rf) {
  _slew[el][rf] = (el == EARLY) ? OT_FLT_MAX : OT_FLT_MIN;
}

// Procedure: remove_at
// Unset the at.
inline void_t Node::remove_at(int el, int rf) {
  _at[el][rf] = (el == EARLY) ? OT_FLT_MAX : OT_FLT_MIN;
...
inline bool_t Node::is_in_pipeline() const {
  return _pipeline_satellite != nullptr;
}

// Function: is_idx_set
// Query the index status.
inline bool_t Node::is_idx_set() const {
  return _idx != OT_UNDEFINED_IDX;
}
